...
<form method="post" action="../src/data/save.php">
    ...
    <input type="number" name="qtde" value="<?= $resultDb[0]->qtde ?>" min="1">
            ...
            <div class="d-flex">
                ...
                <div class="form-check col-lg-2 col-sm-4">
                    <input type="radio" class="form-check-input" name="pgto" value="Pix" <?= ($resultDb[0]->pgto == "Dinheiro") ? "checked" :"" ?>/> Pix
                </div>
                <div class="form-check col-lg-2 col-sm-4">
                    <input type="radio" class="form-check-input" name="pgto" value="Cartão"<?= ($resultDb[0]->pgto == "Dinheiro") ? "checked" :"" ?>/> Cartão
                </div>
            </div>
            <hr>
            <h5>Entrega:</h5>
            <div class="row">
                <div class="col-4">
                    <select name="entrega" required class="form-select col-4">
            ...
            <input type="submit" value="Atualizar pedido" class="btn btn-secundary">
    </div>
</form>
